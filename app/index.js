...
/***/ function(module, exports, __webpack_require__) {
	...
	// React components
	var Details = __webpack_require__(1);
	...
	var SearchResults = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    fetch('listing.json').then(function (res) {
	      return res.json();
	    }).then(function (listing) {
	      var Ilisting = Immutable.fromJS(listing);
	      var parkings = Ilisting.get('data');
	      _this.renderMap(Ilisting.get('coords').map(function (v) {
	        return parseFloat(v);
	      }));
	      _this.renderMarkers(parkings);
	      _this.setState({ // eslint-disable-line
	        parkings: parkings
	      });
	    });
	  ...
	  renderMap: function renderMap(coords) {
	  ...
	  renderMarkers: function renderMarkers(parkings) {
	    var _this2 = this;
	    ...
	    parkings.forEach(function (parking, i) {
	      ...
	      google.maps.event.addListener(marker, 'click', function () {
	        ...
	        if (_this2.state.isMobile) {
	          var mobilePane = React.findDOMNode(_this2.refs.mobilePane);
	          Velocity(mobilePane, 'scroll');
	        } else {
	          var pane = React.findDOMNode(_this2.refs.pane);
	          var mapCanvas = React.findDOMNode(_this2.refs.mapCanvas);
	          if (selected === i) {
	        ...
	        _this2.setState({ selected: selected === i ? -1 : i });
	        // Drawing directions
	        _this2.directionsService.route({
	          origin: marker.getPosition(),
	          destination: new google.maps.LatLng(51.555853, -0.279594),
	          travelMode: google.maps.TravelMode.WALKING
	        }, function (response) {
	          return _this2.directionsDisplay.setDirections(response);
	        });
	      });
	    });
	  },
	  renderPaneContent: function renderPaneContent() {
	    if (this.state.selected !== -1) {
	      return React.createElement(Details, { parking: this.state.parkings.get(this.state.selected) });
	    }
	  },
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'h100' },
	      React.createElement('div', { className: 'h100', ref: 'mapCanvas' }),
	      React.createElement(
	        'div',
	        { className: 'widget', ref: 'mobilePane' },
	        this.state.isMobile ? this.renderPaneContent() : null
	      ),
	      React.createElement(
	        'div',
	        { className: 'h100 widget', style: s.pane, ref: 'pane' },
	        !this.state.isMobile ? this.renderPaneContent() : null
	      )
	    );
	  }
	...
	React.render(React.createElement(SearchResults, null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Details = React.createClass({
	  ...
	  getImgUrl: function getImgUrl(suffix) {
	    return 'https://justpark.com' + suffix;
	  },
	  renderPhotos: function renderPhotos() {
	    var _this = this;

	    return this.props.parking.getIn(['photos', 'user_added'], []).map(function (photo) {
	      return React.createElement('img', {
	        style: s.thumb,
	        key: photo.get('id'),
	        src: _this.getImgUrl(photo.getIn(['json_data', 'small', 'url']))
	      });
	    });
	  },
	  renderAvailability: function renderAvailability() {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'h3',
	        null,
	        this.props.parking.get('spaces_to_rent'),
	        ' space(s)'
	      ),
	      React.createElement(
	        'div',
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'span',
	          null,
	          this.props.parking.getIn(['feedback', 'rating']),
	          ' '
	        ),
	        '(',
